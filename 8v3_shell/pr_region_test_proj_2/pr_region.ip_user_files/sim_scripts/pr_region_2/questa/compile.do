...
vlog -work xil_defaultlib -64 -sv "+incdir+../../../../pr_region.srcs/sources_1/bd/pr_region_2/ipshared/ec67/hdl" \
...
vlog -work generic_baseblocks_v2_1_0 -64 "+incdir+../../../../pr_region.srcs/sources_1/bd/pr_region_2/ipshared/ec67/hdl" \
"../../../../pr_region.srcs/sources_1/bd/pr_region_2/ipshared/b752/hdl/generic_baseblocks_v2_1_vl_rfs.v" \

vlog -work axi_infrastructure_v1_1_0 -64 "+incdir+../../../../pr_region.srcs/sources_1/bd/pr_region_2/ipshared/ec67/hdl" \
"../../../../pr_region.srcs/sources_1/bd/pr_region_2/ipshared/ec67/hdl/axi_infrastructure_v1_1_vl_rfs.v" \

vlog -work axi_register_slice_v2_1_18 -64 "+incdir+../../../../pr_region.srcs/sources_1/bd/pr_region_2/ipshared/ec67/hdl" \
"../../../../pr_region.srcs/sources_1/bd/pr_region_2/ipshared/cc23/hdl/axi_register_slice_v2_1_vl_rfs.v" \

vlog -work fifo_generator_v13_2_3 -64 "+incdir+../../../../pr_region.srcs/sources_1/bd/pr_region_2/ipshared/ec67/hdl" \
...
vlog -work axi_data_fifo_v2_1_17 -64 "+incdir+../../../../pr_region.srcs/sources_1/bd/pr_region_2/ipshared/ec67/hdl" \
"../../../../pr_region.srcs/sources_1/bd/pr_region_2/ipshared/c4fd/hdl/axi_data_fifo_v2_1_vl_rfs.v" \

vlog -work axi_crossbar_v2_1_19 -64 "+incdir+../../../../pr_region.srcs/sources_1/bd/pr_region_2/ipshared/ec67/hdl" \
"../../../../pr_region.srcs/sources_1/bd/pr_region_2/ipshared/6c9d/hdl/axi_crossbar_v2_1_vl_rfs.v" \

vlog -work xil_defaultlib -64 "+incdir+../../../../pr_region.srcs/sources_1/bd/pr_region_2/ipshared/ec67/hdl" \
...
vlog -work axi_protocol_converter_v2_1_18 -64 "+incdir+../../../../pr_region.srcs/sources_1/bd/pr_region_2/ipshared/ec67/hdl" \
"../../../../pr_region.srcs/sources_1/bd/pr_region_2/ipshared/7a04/hdl/axi_protocol_converter_v2_1_vl_rfs.v" \

vlog -work axi_clock_converter_v2_1_17 -64 "+incdir+../../../../pr_region.srcs/sources_1/bd/pr_region_2/ipshared/ec67/hdl" \
"../../../../pr_region.srcs/sources_1/bd/pr_region_2/ipshared/693a/hdl/axi_clock_converter_v2_1_vl_rfs.v" \

vlog -work blk_mem_gen_v8_4_2 -64 "+incdir+../../../../pr_region.srcs/sources_1/bd/pr_region_2/ipshared/ec67/hdl" \
"../../../../pr_region.srcs/sources_1/bd/pr_region_2/ipshared/37c2/simulation/blk_mem_gen_v8_4.v" \

vlog -work axi_dwidth_converter_v2_1_18 -64 "+incdir+../../../../pr_region.srcs/sources_1/bd/pr_region_2/ipshared/ec67/hdl" \
