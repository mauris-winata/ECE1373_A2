...
#
# Generated by export_simulation on Mon Mar 01 15:52:48 -0500 2021
#
################################################################################
...
'-reset_run' switch to the './pr_region_2.sh' script.

./pr_region_2.sh -reset_run
...
./pr_region_2.sh -noclean_files

For more information on the script, please type './pr_region_2.sh -help'.
