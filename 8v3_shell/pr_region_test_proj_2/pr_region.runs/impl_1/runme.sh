...
HD_PWD='D:/Documents/ECE1373/lab2/ECE1373_assignment2-2021/8v3_shell/pr_region_test_proj_2/pr_region.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log pr_region_2_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source pr_region_2_wrapper.tcl -notrace
